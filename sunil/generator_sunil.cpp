...
void func(vector<char> mainarray, vector<char> priorarray, vector<ULLI> priority, ULLI k){ // function to solve the actual task of the problem
	vector<char> v1;
	map<char, ULLI> mp;
...
int main(){
	...
	func(mainarray, priorarray, priority, k);
	cout<<endl;
	return 0;
}